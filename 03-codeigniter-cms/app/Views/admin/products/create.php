                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div class="lg:col-span-2 space-y-5">
                                ...
                                <div>
                                    ...
                                    <textarea
                                        name="description"
                                        rows="5"
                                        class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-gray-900"></textarea>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="border border-gray-200 rounded-2xl p-4 bg-gray-50">
                                    <div class="w-full h-64 rounded-xl border border-gray-200 bg-white flex items-center justify-center overflow-hidden">
                                        <img
                                            id="previewImage"
